...
@section('content')
<!-- <h4 class="py-3 mb-4"><span class="text-muted fw-light">Administrator/</span> Edit Diklat</h4> -->
  ...
  <div class="card mb-0">
    ...
    <div class="card-body">
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <p class="mb-0"><small>BIMTEK TEKNOLOGI Balai Tekkomdik 2024</small></p>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <p class="mb-0"><small>14 Aug s/d 16 Aug 2024</small></p>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <p class="mb-0"><small>80 Peserta</small></p>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <p class="mb-0"><small>99 Pendaftar</small></p>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <p class="mb-0"><small>Pendaftaran Sudah Ditutup / Pendaftarn Masih Dibuka</small></p>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <p class="mb-0"><small>Pengumuman Belum Diterbitkan</small></p>
        </div>
      </div>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-9">
          <p class="mb-0"><small>Belum ada</small></p>
        </div>
      </div>
    </div>
  </div>
          ...
          <table class="table table-hover w-100">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                <td><small>1</small></td>
                <td>
                  <span style="font-weight: bold; color: var(--bs-secondary);">Bapa Budi Satu</span><br>
                  <span>
                    <small>Jabatan Mengajar: </small><small class="jabatan">Guru Muda</small> </span><br>
                  <span>
                    <small>dari: </small><small class="asal-sekolah">SMKN 1 Jogja (Yogyakarta)</small>
                  </span>
                </td>
              ...
              <tr>
                <td><small>2</small></td>
                <td>
                  <span style="font-weight: bold; color: var(--bs-secondary);">Bapa Budi Dua</span><br>
                  <span>
                    <small>Jabatan Mengajar: </small><small class="jabatan">Guru Muda</small> </span><br>
                  <span>
                    <small>dari: </small><small class="asal-sekolah">SMKN 1 Nglipar (Gunungkidul)</small>
                  </span>
                </td>
...
.dropdown-with-icon .dropdown-icon {
  ...
  font-size: 1.5rem;
  pointer-events: none; /* Supaya tidak mengganggu klik pada dropdown */
}
          ...
          <table class="table table-hover w-100">
            ...
            <tbody class="table-border-bottom-0">
              ...
              <tr>
                ...
                <td><small>
                    - (2021) Pendataan Ulang Peserta Bimbingan Teknis Produksi Media Pembelajaran Berbasis Video
                    Angkatan 2
    ...
    if (hapusPesertaIcon.classList.contains('bx-x-circle')) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          Swal.fire({
            ...
            icon: "success"
                    ...
                    <!-- Button edit -->
                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#modalEditDiklatPeserta"
                      title="Edit Diklat Peserta">
                      <i class="bx bx-edit"></i>
                    </a>
                    
                    <div class="modal fade" id="modalEditDiklatPeserta" tabindex="-1" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="modalEditDiklatPesertaTitle">Edit Diklat Peserta</h5>
                          ...
                          <div class="modal-body">
                            <div class="row mb-3">
                              <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="namaPeserta" value="Bapa Budi Satu"
                                  readonly />
                              </div>
                            </div>
                            <div class="row mb-3">
                              <div class="col-12">
                                <label for="asalSekolahPeserta" class="form-label">Asal Sekolah</label>
                                <input type="text" class="form-control" id="asalSekolahPeserta"
                                  value="SMKN 1 Jogja (Yogyakarta)" readonly />
                              </div>
                            </div>
                            <div class="row mb-3">
                              <div class="col">
                                <label for="pilihDiklatPeserta" class="form-label">Pilih Diklat</label>
                                <div class="dropdown-with-icon">
                                  <i class="bx bxs-graduation dropdown-icon"></i>
                                  <select class="form-select ps-5" id="pilihDiklatPeserta">
                                    <option selected value="diklat-sebelumnya">Pendataan Ulang Peserta BIMTEK Produksi
                                      Media Pembelajaran Video</option>
                                    <option value="diklat-1">BIMTEK Online Pemanfaatan TIK Tahun 2023</option>
                                    <option value="diklat-2">Pelatihan Pengelolaan Sistem Informasi Sekolah</option>
                                    <option value="diklat-3">Workshop Desain Media Pembelajaran Interaktif</option>
                                  </select>
                                </div>
                              </div>
                            </div>
        ...
        <tr>
          ...
          <td><small>
              - (2021) Pendataan Ulang Peserta Bimbingan Teknis Produksi Media Pembelajaran Berbasis Video Angkatan 2
              - BIMTEK ONLINE PEMANFAATAN TIK. Angkatan 1 Tahun 2023</small></td>
          <td class="actions">
            <div class="d-flex gap-0 justify-content-start">
              <!-- Tombol Hapus Diklat -->
