      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          ...
          <td>
            <!-- Status Dropdown -->
            <div class="btn-group">
              <button type="button" id="statusButton1" class="btn btn-outline-success dropdown-toggle btn-sm"
        ...
        <tr>
          ...
          <td>
            <!-- Status Dropdown -->
            <div class="btn-group">
              <button type="button" id="statusButton2" class="btn btn-outline-success dropdown-toggle btn-sm"
                data-bs-toggle="dropdown" aria-expanded="false">
                Dibuka
              </button>
              <ul class="dropdown-menu">
