...
@section('layoutContent')
    ...
    <main class="container py-4">
        <h1 class="fs-4 fw-bold mb-4 text-primary">Diklat Tahun: 2024</h1>
                    ...
                    <div class="col">
                        <div class="card d-flex flex-row align-items-center p-3">
                            ...
                            <div class="card-body pb-1 flex-grow-1">
                                ...
                                <small class="text-muted" style="font-size: 0.8rem;">{{ $diklat->pesertaMendaftar->count() }} Pendaftar</small>
                            </div>
                            <div class="buttons-container">
                                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalSyaratKetentuan{{ $diklat->id }}">
        ...
        @else
            <main class="container py-5 text-center">
                ...
                <div class="mt-5">
                    <img src="https://storage.googleapis.com/a1aa/image/uVuHkkWH0yKVAxK6BeGXk2M21UMFgjDfUpPk5HNo3TSYtD6TA.jpg" alt="Illustrati" class="img-fluid rounded-circle shadow-sm" style="width: 200px; height: 200px;">
