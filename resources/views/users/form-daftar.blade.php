    ...
    <div class="container py-5">
        ...
        <div class="container mt-5 mb-4">
            <div class="row align-items-center">
                ...
                <div class="col mt-1">
                    ...
                    <p class="text-muted mb-0">NIK: {{ $dataDiri->nik ?? 'Tidak tersedia' }}</p>
                </div>
            </div>
        </div>
        @else
        ...
        <div class="row">
            <div class="col-md-12 form-container">
                ...
                <form action="{{ route('users.form-daftar') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="nama" class="form-control"
                                value="{{ $dataDiri->nama ?? old('nama') }}"
                                {{ isset($dataDiri->nama) ? 'readonly' : 'required' }}>
                        </div>
                        <div class="col-md-12">
